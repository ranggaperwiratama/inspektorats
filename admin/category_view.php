<div class="span10">  
    ...
    <tbody>
        ...
        <td style="text-align: center;"><a title="edit" href="<?php echo site_url('admin/category_edit').'/'.$cat['id']; ?>"><img src="<?php echo base_url(); ?>aset/icons/pencil.png"/></a> </td>
        <td style="text-align: center;"><a title="delete" class="del" id="cat_id_<?php echo $cat['id']; ?>" href="<?php echo site_url('admin/category_delete').'/'.$cat['id']; ?>"><img src="<?php echo base_url(); ?>aset/icons/delete.png"/></a> </td>
        </tr>
        <?php endforeach; ?>
    </tbody>
    </table>
