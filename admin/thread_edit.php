...
<div class="span6">
    <div class="page-header">
        <h3 style="text-align:center;">Edit Pertanyaan</h3>
    </div>
    ...
    <input type="submit" style="margin-top:15px;font-weight: bold;" name="btn-save" class="btn btn-primary btn-large" value="Simpan Pertanyaan"/>
    </form>
</div>
<div class="span2"></div>