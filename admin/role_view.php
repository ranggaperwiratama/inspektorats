<div class="span10">  
    ...
    <div class="modal hide" id="modalConfirm">
        ...
        <p style="text-align: center;">Apakah Anda yakin menghapus role ini ?</p>
        </div>
    ...
    <div class="alert alert-info">
        ...
        <h4 class="alert-heading">Role dihapus!</h4>
    </div>
    <?php endif; ?>
    ...
    <div class="span2">
        ...
        <tbody>
            ...
            <tr><td><b>Pertanyaan</b></td></tr>
            <tr><td>&mdash; membuat</td></tr>
            <tr><td>&mdash; merubah</td></tr>
            <tr><td>&mdash; menghapus</td></tr>
            ...
            <tr><td>&mdash; membuat</td></tr>
            <tr><td>&mdash; merubah</td></tr>
            <tr><td>&mdash; menghapus</td>
			<tr><td><b>FAQ</b></td></tr>
            <tr><td>&mdash; membuat</td></tr>
            <tr><td>&mdash; merubah</td></tr>
            <tr><td>&mdash; menghapus</td></tr>
			<tr><td><b>Penjawab</b></td></tr>
        </tbody>
        </table>
    </div>
    ...
    <div class="span8">
        ...
        <tbody>
             <tr>
                <?php foreach ($roles as $role): ?>
                <td>
                    <a title="edit" href="<?php echo site_url('admin/role_edit').'/'.$role['id']; ?>"><img src="<?php echo base_url(); ?>aset/icons/pencil.png"/></a> 
                    &nbsp;&nbsp;
                    <a title="delete" class="del" id="role_id_<?php echo $role['id']; ?>" href="<?php echo site_url('admin/role_delete').'/'.$role['id']; ?>"><img src="<?php echo base_url(); ?>aset/icons/delete.png"/></a> 
                </td>
                <?php endforeach; ?>
            </tr>
			<tr>
                ...
                <td>
                    ...
                    <img src="<?php echo base_url(); ?>aset/icons/accept.png"/>
                    <?php else: ?>
                    <img src="<?php echo base_url(); ?>aset/icons/stop.png"/>
                    <?php endif; ?>
                </td>
                <?php endforeach; ?>
            </tr>
