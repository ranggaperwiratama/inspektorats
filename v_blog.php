 <div class="span9">
		...
		<legend style="margin-bottom: 10px">Indeks Berita</legend>
		...
		?>
		 ...
		 <p style="display: block;">
		  ...
		  <div class="span3 thumbnail" style="margin-left: 0px"><img style="height: 100px"src="<?=base_URL()?>upload/post/<?=$b->gambar?>"></div>
		  <div class="span9" style=" text-align: justify">
		  <?=substr(strip_tags($b->isi), 0, 300)." ... "?> <a href="<?=base_URL()?>index.php/tampil/blog/baca/<?=$b->id?>/<?=getURLFriendly($b->judul)?>">[baca selengkapnya]</a>
		  </div>
		</p>
		<br><br><br><br><br><br>
		  <?php $pch_kat	= explode("-", $b->kategori); ?>
