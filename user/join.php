<div class="row-fluid">
    ...
    <div class="span4">
        ...
        <div class="alert alert-success">
            ...
            <h4 class="alert-heading">Akun ditambah!</h4>
        </div>
        <?php endif; ?>
        <?php if (isset($error)): ?>
        ...
        <input type="submit" style="margin-top:15px;font-weight: bold;" name="btn-reg" class="btn btn-primary btn-large" value="Buat Akun"/>
        </form>
    </div>
    
    <div class="span2" style="text-align: center;padding-top: 160px;"><h1>ATAU
	</h1></div>
