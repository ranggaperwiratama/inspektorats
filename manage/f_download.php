...
<input type="hidden" name="gambar" value="<?=$gambar?>">
	...
	<label style="width: 150px; float: left">File maks. 64mb (xlsx,xls,doc,docx,pdf,jpg,gif,png)<br>(Maks 64MB)</label><br><br><input class="span11 "style="float: left; display: block" class="search-query" type="file" name="file_gambar" placeholder="Isikan judulnya"><br><br>
