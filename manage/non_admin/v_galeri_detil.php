<legend style="margin-bottom: 10px">Album Galeri Foto &raquo; <?=$detalb->nama?></legend>
	...
	<form action="<?=base_URL()?>non_admin/galeri/rename_album" method="post">
	...
	<form action="<?=base_URL()?>non_admin/galeri/upload_foto" method="post" accept-charset="utf-8" enctype="multipart/form-data">
	  ...
	  ?>
		<li class="span4" style="margin-left: 0px; margin-right: 9px">
			<div class="thumbnail" style="height: 240px">
				...
				<a href="<?=base_URL()?>non_admin/galeri/del_foto/<?=$detalb->id?>/<?=$d->id?>" onclick="return confirm('Anda Yakin?'); ">Hapus Foto</a></h6>
