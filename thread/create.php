...
<div class="span6">
        <div class="page-header">
            <h3 style="text-align:center;">Membuat Pertanyaan Baru</h3>
        </div>
        <?php if (isset($error)): ?>
        ...
        <input type="submit" style="margin-top:15px;font-weight: bold;" name="btn-create" class="btn btn-primary btn-large" value="Ajukan Pertanyaan"/>
        </form>
    </div>
<div class="span3"></div>